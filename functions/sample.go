...
func (s *Sample) SetResponseData(ctx interfaces.AppFunctionContext, data interface{}) (bool, interface{}) {
	lc := ctx.LoggingClient()
	lc.Debugf("Setting response data in pipeline '%s'", ctx.PipelineId())

	//Data structure for publishing in messagebus

	prueba := "{\"apiVersion\":\"v3\",\"event\":{\"apiVersion\":\"v3\",\"id\":\"0a416674-075f-41db-9b46-981762f121e1\",\"deviceName\":\"Random-Float-Device\",\"profileName\":\"Random-Float-Device\",\"sourceName\":\"Float32\",\"origin\":1715677461975452238,\"readings\":[{\"id\":\"c8249265-52bd-458a-bfa1-8324590bc792\",\"origin\":1715677461975452238,\"deviceName\":\"Random-Float-Device\",\"resourceName\":\"Custom\",\"profileName\":\"Random-Float-Device\",\"valueType\":\"Float32\",\"value\":\"0000\"}]}}"
	...
	ctx.SetResponseData([]byte(prueba))
	ctx.SetResponseContentType("application/json")
	lc.Infof(string(ctx.ResponseData()))
	return false, nil
